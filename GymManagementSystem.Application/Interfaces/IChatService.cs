...
namespace GymManagementSystem.Application.Interfaces
{
    public interface IChatService
    {
        ...
        Task<ChatMessageDto> SendAttachmentAsync(string senderId, string receiverId, string? message, GymManagementSystem.Domain.Enums.MessageType type, string attachmentUrl, CancellationToken cancellationToken = default);
        ...
        Task<IReadOnlyList<string>> GetRelatedUserIdsAsync(string userId, CancellationToken cancellationToken = default);
